...
train_generator = generator(train_samples, batch_size=test_batch_size)
validation_generator = generator(validation_samples, batch_size=test_batch_size)
...
history_object = model.fit_generator(train_generator, samples_per_epoch= \
                 ...
                 nb_val_samples=len(validation_samples), nb_epoch=test_epochs, verbose=1)

model_name = 'model_' + str(test_epochs) + '-' + str(test_batch_size) + '.h5'
model.save('k_model'+model_name+'.h5')
plot_name = 'model_'  + str(test_epochs) + '-' + str(test_batch_size) + 'plt'
...
plt.title('model mean squared error loss - ' + str(model_name) + 'validation loss - ' + str(history_object.history['val_loss'][test_epochs-1]))
plt.ylabel('mean squared error loss')
plt.xlabel('epoch')
plt.legend(['training set', 'validation set'], loc='upper right')
plt.suptitle('Epochs = ' + str(test_epochs) + '  Batch size: '+ str(test_batch_size))
